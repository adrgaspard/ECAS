...
namespace ECAS.IdentityService.Migrations;
...
public partial class Initialization : Migration
{
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        _ = migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                _ = table.PrimaryKey("PK_AbpClaimTypes", x => x.Id);
            });
        ...
        _ = migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                _ = table.PrimaryKey("PK_AbpLinkUsers", x => x.Id);
            });
        ...
        _ = migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                _ = table.PrimaryKey("PK_AbpOrganizationUnits", x => x.Id);
                _ = table.ForeignKey(
        ...
        _ = migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                _ = table.PrimaryKey("PK_AbpRoles", x => x.Id);
            });
        ...
        _ = migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                _ = table.PrimaryKey("PK_AbpSecurityLogs", x => x.Id);
            });
        ...
        _ = migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                _ = table.PrimaryKey("PK_AbpUsers", x => x.Id);
            });
        ...
        _ = migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                _ = table.PrimaryKey("PK_IdentityServerApiResources", x => x.Id);
            });
        ...
        _ = migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                _ = table.PrimaryKey("PK_IdentityServerApiScopes", x => x.Id);
            });
        ...
        _ = migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                _ = table.PrimaryKey("PK_IdentityServerClients", x => x.Id);
            });
        ...
        _ = migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                _ = table.PrimaryKey("PK_IdentityServerDeviceFlowCodes", x => x.Id);
            });
        ...
        _ = migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                _ = table.PrimaryKey("PK_IdentityServerIdentityResources", x => x.Id);
            });
        ...
        _ = migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                _ = table.PrimaryKey("PK_IdentityServerPersistedGrants", x => x.Key);
            });
        ...
        _ = migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                _ = table.PrimaryKey("PK_AbpOrganizationUnitRoles", x => new { x.OrganizationUnitId, x.RoleId });
                _ = table.ForeignKey(
        ...
        _ = migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                _ = table.PrimaryKey("PK_AbpRoleClaims", x => x.Id);
                _ = table.ForeignKey(
        ...
        _ = migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                _ = table.PrimaryKey("PK_AbpUserClaims", x => x.Id);
                _ = table.ForeignKey(
        ...
        _ = migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                _ = table.PrimaryKey("PK_AbpUserLogins", x => new { x.UserId, x.LoginProvider });
                _ = table.ForeignKey(
        ...
        _ = migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                _ = table.PrimaryKey("PK_AbpUserOrganizationUnits", x => new { x.OrganizationUnitId, x.UserId });
                _ = table.ForeignKey(
        ...
        _ = migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                _ = table.PrimaryKey("PK_AbpUserRoles", x => new { x.UserId, x.RoleId });
                _ = table.ForeignKey(
        ...
        _ = migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                _ = table.PrimaryKey("PK_AbpUserTokens", x => new { x.UserId, x.LoginProvider, x.Name });
                _ = table.ForeignKey(
        ...
        _ = migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                _ = table.PrimaryKey("PK_IdentityServerApiResourceClaims", x => new { x.ApiResourceId, x.Type });
                _ = table.ForeignKey(
        ...
        _ = migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                _ = table.PrimaryKey("PK_IdentityServerApiResourceProperties", x => new { x.ApiResourceId, x.Key, x.Value });
                _ = table.ForeignKey(
        ...
        _ = migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                _ = table.PrimaryKey("PK_IdentityServerApiResourceScopes", x => new { x.ApiResourceId, x.Scope });
                _ = table.ForeignKey(
        ...
        _ = migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                _ = table.PrimaryKey("PK_IdentityServerApiResourceSecrets", x => new { x.ApiResourceId, x.Type, x.Value });
                _ = table.ForeignKey(
        ...
        _ = migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                _ = table.PrimaryKey("PK_IdentityServerApiScopeClaims", x => new { x.ApiScopeId, x.Type });
                _ = table.ForeignKey(
        ...
        _ = migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                _ = table.PrimaryKey("PK_IdentityServerApiScopeProperties", x => new { x.ApiScopeId, x.Key, x.Value });
                _ = table.ForeignKey(
        ...
        _ = migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                _ = table.PrimaryKey("PK_IdentityServerClientClaims", x => new { x.ClientId, x.Type, x.Value });
                _ = table.ForeignKey(
        ...
        _ = migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                _ = table.PrimaryKey("PK_IdentityServerClientCorsOrigins", x => new { x.ClientId, x.Origin });
                _ = table.ForeignKey(
        ...
        _ = migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                _ = table.PrimaryKey("PK_IdentityServerClientGrantTypes", x => new { x.ClientId, x.GrantType });
                _ = table.ForeignKey(
        ...
        _ = migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                _ = table.PrimaryKey("PK_IdentityServerClientIdPRestrictions", x => new { x.ClientId, x.Provider });
                _ = table.ForeignKey(
        ...
        _ = migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                _ = table.PrimaryKey("PK_IdentityServerClientPostLogoutRedirectUris", x => new { x.ClientId, x.PostLogoutRedirectUri });
                _ = table.ForeignKey(
        ...
        _ = migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                _ = table.PrimaryKey("PK_IdentityServerClientProperties", x => new { x.ClientId, x.Key, x.Value });
                _ = table.ForeignKey(
        ...
        _ = migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                _ = table.PrimaryKey("PK_IdentityServerClientRedirectUris", x => new { x.ClientId, x.RedirectUri });
                _ = table.ForeignKey(
        ...
        _ = migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                _ = table.PrimaryKey("PK_IdentityServerClientScopes", x => new { x.ClientId, x.Scope });
                _ = table.ForeignKey(
        ...
        _ = migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                _ = table.PrimaryKey("PK_IdentityServerClientSecrets", x => new { x.ClientId, x.Type, x.Value });
                _ = table.ForeignKey(
        ...
        _ = migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                _ = table.PrimaryKey("PK_IdentityServerIdentityResourceClaims", x => new { x.IdentityResourceId, x.Type });
                _ = table.ForeignKey(
        ...
        _ = migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                _ = table.PrimaryKey("PK_IdentityServerIdentityResourceProperties", x => new { x.IdentityResourceId, x.Key, x.Value });
                _ = table.ForeignKey(
